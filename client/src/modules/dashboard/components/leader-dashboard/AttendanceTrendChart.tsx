  ...
  return (
    <div className="bg-white rounded-xl sm:rounded-2xl border border-slate-200 p-4 sm:p-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6 md:mb-8">
        <div>
          <h3 className="text-lg font-bold text-slate-900">Davomat tendentsiyasi</h3>
          <p className="text-xs font-medium text-slate-400 mt-1">Oxirgi 8 kun · kundalik ko'rsatkichlar</p>
        </div>
        <div className="flex items-center gap-3 md:gap-6 text-[10px] md:text-[11px] font-bold uppercase tracking-widest text-slate-400 flex-wrap">
          <span className="flex items-center gap-2"><span className="w-2.5 h-2.5 rounded-full bg-emerald-500" />Kelgan</span>
          <span className="flex items-center gap-2"><span className="w-2.5 h-2.5 rounded-full bg-red-500" />Kelmagan</span>
          <span className="flex items-center gap-2"><span className="w-2.5 h-2.5 rounded-full bg-amber-500" />Kechikkan</span>
        </div>
      </div>
      <div className="h-[200px] md:h-[260px]">
        {attendanceTrend.length === 0 ? (
          <div className="h-full flex items-center justify-center text-sm text-slate-400">Ma'lumot yuklanmoqda…</div>
        ) : (
