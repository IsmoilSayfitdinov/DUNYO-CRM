...
export function EditAttendanceModal({ open, record, onClose, onSave }: any) {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-end sm:items-center justify-center sm:p-4">
      ...
      <div role="dialog" aria-modal="true" aria-label="Davomatni tahrirlash" className="relative w-full max-w-[calc(100vw-2rem)] sm:max-w-md max-h-[92vh] sm:max-h-[90vh] overflow-y-auto bg-white rounded-t-3xl sm:rounded-2xl shadow-2xl border border-slate-200">
        ...
        <div className="flex flex-col-reverse sm:flex-row sm:items-center sm:justify-end gap-2 sm:gap-3 px-4 sm:px-6 py-3 sm:py-4 border-t border-slate-200/50 bg-slate-50 shrink-0 pb-[max(1rem,env(safe-area-inset-bottom))]">
