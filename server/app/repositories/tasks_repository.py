...
class TasksRepository:
    ...
    async def list_for_leader(self, leader_id: UUID) -> list[Task]:
        """Rahbar yaratgan BARCHA vazifalar (xodim + user nomi bilan eager-load)."""
        query = (
            select(Task)
    ...
    async def list_for_employee(self, employee_id: UUID) -> list[Task]:
        """Xodimga biriktirilgan vazifalar."""
        query = (
            select(Task)
